...
export default defineConfig({
  ...
  shortcuts: {
    ...
    // accent for the one primary action (brand system §4.3/§18.1).
    vqBtn:
    ...
    'vq-btn-primary':
      'vq-btn-md bg-[var(--vq-accent)] text-[var(--vq-accent-fg)] hover:bg-[var(--vq-accent-hover)] active:bg-[var(--vq-accent-active)]',
    'vq-btn-secondary':
      'vq-btn-md border border-[var(--vq-border)] bg-[var(--vq-bg-raised)] text-[var(--vq-fg)] hover:bg-[var(--vq-bg-hover)] hover:border-[var(--vq-border-strong)]',
    'vq-btn-ghost':
      'vq-btn-md text-[var(--vq-fg-muted)] hover:bg-[var(--vq-bg-hover)] hover:text-[var(--vq-fg)]',
    'vq-btn-danger':
      'vq-btn-md bg-[var(--vq-danger)] text-[#fff] hover:bg-[var(--vq-danger-hover)]',
    'vq-icon-btn':
    ...
    // ---- Inputs ----
    'vq-input':
      'h-8 w-full rounded-[var(--vq-radius-md)] border border-[var(--vq-border)] bg-[var(--vq-bg)] px-2.5 text-[13px] text-[var(--vq-fg)] placeholder:text-[var(--vq-fg-subtle)] transition-colors duration-[var(--vq-duration-fast)] focus:border-transparent focus:outline-2 focus:outline-solid focus:outline-[var(--vq-ring)]',
    // ---- Surfaces ----
    'vq-panel':
      'rounded-[var(--vq-radius-lg)] border border-[var(--vq-border)] bg-[var(--vq-bg-raised)]',
    'vq-card': 'vq-panel shadow-[var(--vq-shadow-sm)]',
    'vq-code':
    ...
    'vq-tooltip':
      'z-[100] rounded-[var(--vq-radius-md)] border border-[var(--vq-border)] bg-[var(--vq-bg-raised)] px-2 py-1 text-[12px] text-[var(--vq-fg)] shadow-[var(--vq-shadow-md)]',
    'vq-badge':
