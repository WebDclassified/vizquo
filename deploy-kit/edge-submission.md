...
- Package: **`.output/vizquo-0.11.0-chrome.zip`** (Edge is Chromium — accepts the Chrome build)
...
| File | Purpose |
|---|---|
| `.output/vizquo-0.11.0-chrome.zip` | the package you upload |
...
2. **Upload** `.output/vizquo-0.11.0-chrome.zip`.
