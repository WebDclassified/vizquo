...
3. **Add new** → upload `.output/vizquo-0.10.7-chrome.zip`.
...
3. Upload `.output/vizquo-0.10.7-firefox.zip` AND
   `.output/vizquo-0.10.7-sources.zip` (AMO requires source code for MV3).
...
3. **Add new item** → upload `.output/vizquo-0.10.7-chrome.zip`.
