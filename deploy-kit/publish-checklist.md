...
3. **Add new** → upload `.output/release/vizquo-1.0.0/vizquo-1.0.0-chrome.zip`.
...
3. Upload
   `.output/release/vizquo-1.0.0/vizquo-1.0.0-firefox.zip` AND
   `.output/release/vizquo-1.0.0/vizquo-1.0.0-sources.zip` (AMO requires
   source code for MV3).
...
3. **Add new item** → upload `.output/release/vizquo-1.0.0/vizquo-1.0.0-chrome.zip`.
