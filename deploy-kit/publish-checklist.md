...
3. **Add new** → upload `.output/vizquo-0.10.1-chrome.zip`.
...
3. Upload `.output/vizquo-0.10.1-firefox.zip` AND
   `.output/vizquo-0.10.1-sources.zip` (AMO requires source code for MV3).
...
3. **Add new item** → upload `.output/vizquo-0.10.1-chrome.zip`.
