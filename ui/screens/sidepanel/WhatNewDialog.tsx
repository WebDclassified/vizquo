  ...
  return (
    ...
    >
      <KDialog.Portal>
        ...
        <KDialog.Content class="vq-float fixed left-1/2 top-1/2 z-[160] w-[min(460px,calc(100%-32px))] max-h-[80vh] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-[var(--vq-radius-xl)] focus:outline-none">
